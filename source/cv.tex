...
\begin{ResumeSection}{education}
    ...
    \textbf{Relevant courses}: \\
		\textit{C++ Programming, Kotlin Programming, Algorithms and Data Structures, Calculus, Compilers, Computer Architecture, Operating Systems, Networks, Databases}  
    ...
    \textbf{Relevant courses}: \\
		\textit{C++/C\# Programming, (Linear) Algebra, Discrete Mathematics, Calculus, Software Design, Probability Theory, Software Engineering}
    \end{ResumeSubsection}
\end{ResumeSection}
